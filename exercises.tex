...
\[\2^I\iso\powU(I)\]
In particular, \(\powU\)~is representable.\footnote{Compare to Example~7.4.} Dually, \(\2^{\dual{I}}\)~is just the poset of downward closed subsets of~\(I\) under inclusion.
\end{rmk}
\begin{proof}
