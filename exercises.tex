...
\begin{proof}
To see that
\[\varphi\xrightarrow{i_1}\varphi\lor\psi\xleftarrow{i_2}\psi\]
...
\begin{proof}
Suppose
\[P\xrightarrow{i_1}P+Q\xleftarrow{i_2}Q\]
is a coproduct diagram. If \(f:P+Q\to X\) and \(e:E\onto X\), then by projectivity of \(P\)~and~\(Q\) there exist arrows \(\overline{f\after i_1}:P\to E\) and \(\overline{f\after i_2}:Q\to E\) satisfying equations \(e\after\overline{f\after i_k}=f\after i_k\). Define \(\overline{f}=\copair{\overline{f\after i_1}}{\overline{f\after i_2}}\). Then
\[e\after\overline{f}
...
\begin{exer}[8]
An object~\(Q\) is \emph{injective} in a category~\(\C\) if \(\star{Q}\)~is projective in~\(\Cop\), that is, if for all arrows \(f:X\to Q\) and monos \(m:X\into A\), there exists \(\overline{f}:A\to Q\) such that \(\overline{f}\after m=f\).
