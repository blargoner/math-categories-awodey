...
is the component at~\(X\) of a natural transformation \(\eta:1_{\Sets}\to\mathcal{U}\).\footnote{See Section~3.} For a Boolean algebra~\(B\) and function \(f:X\to\ult(B)\), if there is a Boolean homomorphism \(h:B\to\powBA(X)\) making the diagram
\begin{diagram}[nohug]
